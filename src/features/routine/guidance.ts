...
export const COMMON_STRENGTH_STEPS: readonly string[] = [
  '힘을 주는 동안 둘을 세고, 돌아올 때는 넷을 세며 천천히 움직이에요.',
  '힘줄 때 숨을 내쉬고 돌아올 때 들이마셔요. 숨을 참지 마세요.',
  '팔꿈치나 무릎을 끝까지 펴서 잠그지 말고, 살짝 굽힌 상태로 두세요.',
  '반동을 쓰지 말고, 한 세트가 끝나면 1분쯤 쉬었다가 다음 세트를 해요.',
];
...
export const FALLBACK_STEPS: readonly string[] = [
  '기구에 붙은 안내 그림을 보고 자리와 높이를 몸에 맞춰요.',
  '자세를 잡은 뒤 천천히 힘을 주고, 천천히 처음 자리로 돌아와요.',
];
