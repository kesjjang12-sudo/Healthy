-- ═══════════════════════════════════════════════════════════════
-- 아직 서버에 적용 안 된 것: 키·몸무게 기록 (마이그레이션 11)
--
-- Supabase 대시보드 → SQL Editor 에 통째로 붙여넣고 Run.
-- 여러 번 돌려도 안전하다(테이블은 if not exists, 함수는 create or replace).
--
-- 다른 세션이 올린 01~10 번(운동 카탈로그 75종·사진 등)과는 건드리는 테이블이
-- 겹치지 않는다. 이 파일은 body_weight_logs 와 users.profile_data 만 손댄다.
-- ═══════════════════════════════════════════════════════════════
